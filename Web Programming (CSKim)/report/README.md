# Report
- 레포트는 총 4번으로, 교수님이 작성한 프로그램의 일부를 수정해야 합니다.
- 주제는 매년 바뀌지 않으며, 구현 목표가 조금씩 수정됩니다.
- 레포트의 설명과 소스 코드는 각 하위 폴더에 정리되어 있습니다.
- `html`, `css`, `javascript`에 대해 미리 공부한 후 강의를 들으면 좋습니다.
