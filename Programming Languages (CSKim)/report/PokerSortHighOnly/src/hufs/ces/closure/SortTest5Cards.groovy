...
class SortTest5Cards {
    ...
    static void printConvertedList(List<Entry> fcList) {
        ...
        for (Entry fc : fcList) {
            ...
            switch (fc.transform[0]) {
                ...
                case 4: print += "Triple"; break
                case 5: print += "Straight"; break
                case 6: print += "Flush"; break
                case 7: print += "Full House"; break
                case 8: print += "Four Card"; break
                case 9: print += "Straight Flush"; break
            }
    ...
    static main(args) {
        ...
        List<Entry> pokerHighOrder = Modules.setPokerHighOrder(list5card)

        println "\n"
        println "Poker High Order"
        Closure comp = { Entry left, Entry right ->
            // This comparator is Poker High Order
            Integer size
            ...
            for (Integer i = 0; i < size; i++) {
                def temp = (left.transform[i] <=> right.transform[i]) * -1
        ...
        List<Entry> list5cardSorted = new QuickSort().sort(pokerHighOrder, comp)
